    ...
    <div className="bg-gradient-to-br from-gray-950 via-black to-gray-900 text-gray-200 min-h-screen font-sans">
      ...
      <section className="relative container mx-auto px-4 py-28 md:py-40 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-lg md:text-xl text-gray-400 mb-10 max-w-3xl mx-auto">
            Develop powerful communication skills using AI-driven analysis based on rhetorical principles. Navigate diverse perspectives beyond online echo chambers.
          </p>
      ...
      <section className="container mx-auto px-4 py-20 md:py-24">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12">
          <HowItWorksStep number="1" title="Choose a Topic" description="Select from curated, challenging topics designed to broaden your perspective." colorClass="text-cyan-400" />
          <HowItWorksStep number="2" title="Engage & Refine" description="Practice structured argumentation with real-time AI guidance and feedback." colorClass="text-purple-400" />
          <HowItWorksStep number="3" title="Analyze & Improve" description="Receive personalized insights on logical structure, rhetoric, and delivery." colorClass="text-blue-400" />
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left">
              <p className="text-lg italic text-gray-300 mb-4">
                "Aristotle AI has fundamentally changed how I approach difficult conversations. The feedback is insightful, helping me articulate my points clearly and understand opposing arguments better, without the usual online hostility."
              </p>
      ...
      <section className="container mx-auto px-4 py-24 md:py-32 text-center">
        ...
        <p className="text-lg md:text-xl text-gray-400 mb-10 max-w-3xl mx-auto">
          Join a growing community dedicated to mastering communication and fostering understanding in a polarized world. Start your AI-powered debate journey today.
        </p>
        <Link href="/debate">
          <Button
            size="lg"
      ...
      <footer className="container mx-auto px-4 py-8 text-center border-t border-gray-800">
        <p className="text-sm text-gray-500">© {new Date().getFullYear()} Aristotle AI. All rights reserved.</p>
      </footer>
    </div>
  )
}
...
function HowItWorksStep({ number, title, description, colorClass }: { number: string; title: string; description: string; colorClass: string }) {
  return (
    <div className="flex-1 text-center p-4">
      <div className={`w-12 h-12 border-2 ${colorClass.replace('text-', 'border-')} rounded-full flex items-center justify-center mx-auto mb-5`}>
